...
export const AnimatedBorderButton = ({children}) =>{
  return(
    <>
      ...
      <button className="relative bg-transparent border border-border text-[#f0f2f5]  hover:border-[#20b2a6]/50 hover:bg-[#20b2a6]/5 transition-all duration-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-[] focus:visible-offset-2 hover:animated-border disabled:opacity-50 disabled:cursor-not-allowed group px-8 py-4 text-lg font-medium rounded-full overflow-visible animate-border ">
                  {/* Animated SVG Border  */}
                  <svg
